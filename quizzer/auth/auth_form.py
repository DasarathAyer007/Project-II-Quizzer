...
from wtforms import StringField, PasswordField, BooleanField, EmailField, IntegerField,SelectField,SubmitField
...
from .auth_services import username_exists, email_exists
import re
